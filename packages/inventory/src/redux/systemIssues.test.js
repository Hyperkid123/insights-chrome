...
describe("advisor", () => {
  it("should change to loading state", () => {
    const newState = reducer[
      SYSTEM_ISSUE_TYPES.LOAD_ADVISOR_RECOMMENDATIONS_PENDING
    ]({
      systemIssues: {
        test: "unchanged",
        advisor: {
  ...
  it("should NOT change the state", () => {
    const newState = reducer[
      SYSTEM_ISSUE_TYPES.LOAD_ADVISOR_RECOMMENDATIONS_FULFILLED
    ](
      {
        systemIssues: {
          test: "unchanged",
...
describe("compliance", () => {
  it("should change to loading state", () => {
    const newState = reducer[
      SYSTEM_ISSUE_TYPES.LOAD_COMPLIANCE_POLICIES_PENDING
    ]({
      systemIssues: {
        test: "unchanged",
        compliance: {
  ...
  it("should NOT change the state", () => {
    const newState = reducer[
      SYSTEM_ISSUE_TYPES.LOAD_COMPLIANCE_POLICIES_FULFILLED
    ](
      {
        systemIssues: {
          test: "unchanged",
...
describe("patch", () => {
  it("should change to loading state", () => {
    const newState = reducer[
      SYSTEM_ISSUE_TYPES.LOAD_APPLICABLE_ADVISORIES_PENDING
    ]({
      systemIssues: {
        test: "unchanged",
        patch: {
  ...
  it("should NOT change the state", () => {
    const newState = reducer[
      SYSTEM_ISSUE_TYPES.LOAD_APPLICABLE_ADVISORIES_FULFILLED
    ](
      {
        systemIssues: {
          test: "unchanged",
